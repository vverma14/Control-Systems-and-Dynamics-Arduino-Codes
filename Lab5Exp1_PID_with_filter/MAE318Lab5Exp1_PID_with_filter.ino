...
float Error, PreviousError, Error_Derivative, Error_integral; // define the error variables
...
void loop() {
 ...
 float a ;                                                   // filter factor
       ...
       Error_integral   =  Error_integral + Error*((Time-PreviousTime)/1000.0) ;  
                                   
 voltage = kp*Error + +ki*Error_integral + kd*Error_Derivative + Vmin;            // This right here is your PID controller with filter!!!  
