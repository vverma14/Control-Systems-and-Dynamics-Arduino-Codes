...
float DiscSpeed, Error_in_DiscSpeed, Error_integral;                       // define the DiscSpeed variables
...
void setup() {                         // put your setup code here, it will run once at the beginning:
  ...
  Error_integral = 0.0;                                       // initialize the error integral
...
void loop() {
 ...
 float kp = 0.189    ;                                           // proportional gain
 float ki = 5.66   ;                                           // integral gain
 ...
 Error_in_DiscSpeed = (desired_speed - DiscSpeed);
 Error_integral     = Error_integral + Error_in_DiscSpeed*((Time-PreviousTime)/1000.0) ;                    
 voltage = kp*(desired_speed - DiscSpeed)+ki*(Error_integral)+Vmin;     // This is your PI Controller!
